...
Route::get('floor', function(){
    return redirect()->route('floor.ground');
});

// Route::get('floor/{param?}', [FloorController::class, 'detail'])->name('floor.detail');
...
Route::get('coba_lantai', [FloorController::class, 'detail']);
